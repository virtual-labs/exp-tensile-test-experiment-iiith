...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const youngM = [
    6667, 12000, 11000, 8500, 8667, 6375, 5000, 5000, 4286, 3400, 3167, 2800,
    2647, 2350, 2275,
  ];
  const load = [
    7200, 21600, 39600, 45900, 46800, 45900, 45000, 45000, 54000, 61200, 68400,
    75600, 81000, 84600, 81900,
  ];
  const elongation = [
    0.85, 1.7, 3.4, 4.25, 5.1, 5.95, 6.8, 7.65, 10.2, 13.6, 17, 20.4, 23.8,
    27.2, 28.05,
  ];
